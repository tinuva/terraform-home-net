...
# }
# resource "routeros_ipv6_address" "vlan20-ipv6-private" {
#   interface = routeros_vlan.vlan20.name
#   address = "fd00:20::/64"
#   comment = "vlan20-clients"
#   advertise = true
# }
# resource "routeros_ipv6_address" "vlan20-ipv6-public" {
#   interface = routeros_vlan.vlan20.name
#   from_pool = "ipv6-pool"
#   comment = "vlan20-clients"
#   advertise = true
...
# }
# resource "routeros_ip_dhcp_server_network" "vlan20-ipv4-dhcp-server-network" {
#   address = "10.0.2.0/24"
#   gateway = "10.0.2.1"
#   dns_server = "10.0.3.2"
#   ntp_server = "10.0.2.1"
# }
# resource "routeros_ip_dhcp_server" "vlan20-ipv4-dhcp-server" {
#   name = "vlan20-clients"
#   interface = routeros_vlan.vlan20.name
...
# }
# resource "routeros_ipv6_address" "vlan21-ipv6-private" {
#   interface = routeros_vlan.vlan21.name
#   address = "fd00:21::/64"
#   comment = "vlan21-servers"
#   advertise = true
# }
# resource "routeros_ipv6_address" "vlan21-ipv6-public" {
#   interface = routeros_vlan.vlan21.name
#   from_pool = "ipv6-pool"
#   comment = "vlan21-servers"
#   advertise = true
...
# }
# resource "routeros_ip_dhcp_server_network" "vlan21-ipv4-dhcp-server-network" {
#   address = "10.0.3.0/24"
#   gateway = "10.0.3.1"
#   dns_server = "10.0.3.2"
#   ntp_server = "10.0.3.1"
# }
# resource "routeros_ip_dhcp_server" "vlan21-ipv4-dhcp-server" {
#   name = "vlan21-servers"
#   interface = routeros_vlan.vlan21.name
...
#  comment = "vlan22-iot"
#}
#resource "routeros_ipv6_address" "vlan22-ipv6-private" {
#  interface = routeros_vlan.vlan22.name
#  address = "fd00:22::/64"
#  comment = "vlan22-iot"
#  advertise = true
#}
#resource "routeros_ipv6_address" "vlan22-ipv6-public" {
#  interface = routeros_vlan.vlan22.name
#  from_pool = "ipv6-pool"
#  comment = "vlan22-iot"
#  advertise = true
...
#}
#resource "routeros_ip_dhcp_server_network" "vlan22-ipv4-dhcp-server-network" {
#  address = "10.0.4.0/24"
#  gateway = "10.0.4.1"
#  dns_server = "10.0.3.2"
#  ntp_server = "10.0.4.1"
#}
#resource "routeros_ip_dhcp_server" "vlan22-ipv4-dhcp-server" {
#  name = "vlan22-iot"
#  interface = routeros_vlan.vlan22.name
#  address_pool = routeros_ip_pool.vlan22-ipv4-pool.name
#  lease_time = "4w3d"
#  dhcp_option_set = "default"
#}
...
#   comment = "vlan23-iot2"
# }
# resource "routeros_ipv6_address" "vlan23-ipv6-private" {
#   interface = routeros_vlan.vlan23.name
#   address = "fd00:23::/64"
#   comment = "vlan23-iot"
#   advertise = true
# }
# resource "routeros_ipv6_address" "vlan23-ipv6-public" {
#   interface = routeros_vlan.vlan23.name
#   from_pool = "ipv6-pool"
#   comment = "vlan23-iot"
#   advertise = true
...
# }
# resource "routeros_ip_dhcp_server_network" "vlan23-ipv4-dhcp-server-network" {
#   address = "10.0.5.0/24"
#   gateway = "10.0.5.1"
#   dns_server = "10.0.3.2"
#   ntp_server = "10.0.5.1"
# }
# resource "routeros_ip_dhcp_server" "vlan23-ipv4-dhcp-server" {
#   name = "vlan23-iot2"
#   interface = routeros_vlan.vlan23.name
...
# }
# resource "routeros_ip_dhcp_server_network" "vlan24-ipv4-dhcp-server-network" {
#   address = "10.0.6.0/24"
#   gateway = "10.0.6.1"
#   dns_server = "10.0.3.2"
#   ntp_server = "10.0.6.1"
# }
# resource "routeros_ip_dhcp_server" "vlan24-ipv4-dhcp-server" {
#   name = "vlan24-legacy-wifi"
#   interface = routeros_vlan.vlan24.name
